...
from llm_calls import summarise_website, categorize_website, get_subcategories, summarise_and_categorize_websites
...
summaries_and_categories = summarise_and_categorize_websites(extracted_text)    # subkategorisierung macht hier noch keinen Sinn, da nur wenige Artikel
for url in summaries_and_categories:                                            # pro Durchlauf ankommen -> Daher subkategorisierung zsm. mit Mail-Versand
    print(f"URL: {url}")
...
print(f"Die Funktion summarise_and_categorize_websites benötigte {elapsed_time:.2f} Sekunden.")
